...
5. Make the module available, publicly.
    ```bash
    GOPROXY=proxy.golang.org go list -m "github.com/x-Polygun/example@v$(head VERSION)"
    ```
...
- Example: https://dev.go.dev/github.com/x-Polygun/example

Upon successful request, a message should be displayed:

> _We're still working on “github.com/x-Polygun/example”. Check back in a few minutes!_
